const zh_cn_translate = {
    ...
    navbar_misc: ['鹿乃按钮', '网站信息'],
    song_record_table_title: ['曲名', '最近一次演唱', '演唱次数', '油管演唱次数', 'B站演唱次数'],
    footer_title: ['官方商店', '频道链接', '直播间'],
    footer_links: ['Booth', 'Twitter', 'Youtube', 'Bilibili', 'Pixiv FANBOX', 'TwitCasting', 'BiliBili主播日历', 'BiliBili直播间'],
    footer_maintain: '本站由 <a href="https://twitter.com/huiqiang233" rel="noopener" target="_blank">辉枪233</a> 设计、构建和维护。',
    ...
    footer_warning: '本网站是鹿乃的非官方信息站，所有的信息请以鹿乃的官方信息公布平台为准。<br>本网站不保证信息的准确性，所有数据可能会随时进行修改。',
    footer_copyright: '本网站为非官方制作。网站中的信息、图片、音频及其他数据均来自鹿乃官方账号。这些数据的著作权归原作者所有。本网站仅供学习娱乐交流使用，并且禁止除鹿乃官方与原版权所有者以外的任何人用于商业用途。如果您有任何疑问，请发送邮件到<a href="mailto:haolei.ye@anu.edu.au">huiqiang.info@gmail.com</a>咨询。',
    footer_author: '程序、维护、数据收集、杂役：',
    footer_data_correct: '数据检查：',
    footer_resource: '素材提供：',
    title_stream: '鹿乃的全部直播',
    title_calender: '鹿乃直播日历',
    title_single: '鹿乃的单曲',
    title_song_list: '鹿乃的演唱会歌单',
    ...
    title_forecast_today: '鹿乃今天的直播预定',
    title_forecast: '鹿乃直播计划表',
    title_misc: '鹿乃标记今天很好！（?)',
    title_about: ['信息收集'],
    ...
    count_first_v: function(n) { return `距离鹿乃出道已经 ${n} 天`; },
    count_first_y: function(n) { return `距离鹿乃第一次直播已经 ${n} 天`; },
    count_first_b: function(n) { return `距离鹿乃第一次B站直播已经 ${n} 天`; },
