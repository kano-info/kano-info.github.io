...
function day_counter_render() {
    ...
    document.getElementById('day-counter').innerHTML = "<div>" +app_i18n.count_first_v(Math.floor((today - new Date("2015-05-20")) / day_divider)) + "</div>" +
        "<div>" +app_i18n.count_first_y(Math.floor((today - new Date("2015-05-22")) / day_divider)) + "</div>" +
        "<div>" +app_i18n.count_first_b(Math.floor((today - new Date("2019-08-03")) / day_divider)) + "</div>"
}
